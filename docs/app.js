...
(function () {
  ...
  function fetchHotels() {
    allHotels = HotelDB.getHotels();
    buildRegionFilters();
    applyFilters();
  }

  function fetchStats() {
    var stats = HotelDB.getStats();
  ...
  function saveHotel(data) {
    HotelDB.saveHotel(data);
  }

  function deleteHotel(id) {
    HotelDB.deleteHotel(id);
  }
  ...
  document.getElementById('import-submit').addEventListener('click', () => {
    alert('Demo mode - import disabled');
  });
  ...
  document.getElementById('email-mark-contacted').addEventListener('click', () => {
    const markBtn = document.getElementById('email-mark-contacted');
    ...
    HotelDB.updateOutreach(hotelId, { contacted: true });
    HotelDB.addTimeline(hotelId, { action: 'Email Sent', note: 'Outreach email to ' + to + ' - ' + subject });
